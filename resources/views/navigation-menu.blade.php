        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ Auth::user()->role === 'ADMIN' ? route('dashboard') : route('profile.show') }}">
                        <img src="/img/ums-logo.png" alt="logo" class="h-12 w-auto text-white lg:text-[#FF2D20]"></img>
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    @if (Auth::user()->role === 'ADMIN')
                        <x-nav-link href="{{ route('dashboard') }}" :active="request()->routeIs('dashboard')" style="border-color: #FF2D20;">
                            {{ __('Dashboard') }}
                        </x-nav-link>
                    @endif
                </div>
